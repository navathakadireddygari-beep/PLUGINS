        ...
        {rawHeader && (() => {
          ...
          const infoIcon = (kind: "currency" | "scale" | "number" | "date", tooltipText: string, align: "left" | "right" = "left") => (
            ...
            >
              ...
              {stripTooltip === kind && (
                <span style={{ position: "absolute", [align]: 22, top: -4, background: DARK_TOGGLE, color: "#fff", padding: "6px 10px", borderRadius: 4, fontSize: 13, whiteSpace: "normal", width: 300, lineHeight: 1.5, zIndex: 300 }}>
                  {tooltipText}
                </span>
              )}
            </div>
