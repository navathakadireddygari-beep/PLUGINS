        ...
        {rawHeader && (() => {
          ...
          const infoIcon = (kind: "currency" | "scale", tooltipText: string) => (
            ...
            >
              ...
              {stripTooltip === kind && (
                <span style={{ position: "absolute", left: 20, top: -4, background: DARK_TOGGLE, color: "#fff", padding: "6px 10px", borderRadius: 4, fontSize: 11, whiteSpace: "normal", width: 300, lineHeight: 1.45, zIndex: 300 }}>
                  {tooltipText}
                </span>
              )}
            </div>
